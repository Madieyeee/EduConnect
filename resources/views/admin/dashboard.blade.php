            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.export.schools-pdf') }}" class="bg-green-600 text-white px-3 py-2 rounded-md hover:bg-green-700 transition duration-300 text-sm">
                            <i class="fas fa-file-pdf mr-1"></i>
                            Export Écoles
                        </a>
                        <a href="{{ route('admin.export.students-pdf') }}" class="bg-blue-600 text-white px-3 py-2 rounded-md hover:bg-blue-700 transition duration-300 text-sm">
                            <i class="fas fa-file-pdf mr-1"></i>
                            Export Étudiants
                        </a>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format($stats['total_commission'], 0, ',', ' ') }} CFA</p>
                    </div>
                </div>
            </div>
        </div>
