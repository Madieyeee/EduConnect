<?php $__env->startSection('title', 'Rechercher une école - EduConnect'); ?>
...
<div class="bg-white">
    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <form method="GET" action="<?php echo e(route('schools.index')); ?>" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="field" name="field" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <?php $__currentLoopData = $allFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($field); ?>" <?php echo e(request('field') == $field ? 'selected' : ''); ?>>
                                    <?php echo e($field); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="<?php echo e(route('schools.index')); ?>" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-300 transition duration-300 text-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <?php if($school->tuition_fee_range !== 'Non spécifié'): ?>
                                <p class="text-sm text-gray-600">
                                    ...
                                    <?php echo e($school->tuition_fee_range); ?>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-500">
                                <?php echo e(count($school->diplomas)); ?> diplôme(s)
                            </span>
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <a href="<?php echo e(route('schools.index')); ?>" class="bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 transition duration-300">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\EduConnect\resources\views/schools/index.blade.php ENDPATH**/ ?>