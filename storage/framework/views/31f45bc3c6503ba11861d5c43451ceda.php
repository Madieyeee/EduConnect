<?php $__env->startSection('title', 'Mes candidatures - EduConnect'); ?>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">
                        <?php echo e($applications->total()); ?> candidature(s) au total
                    </h2>
                </div>
                    ...
                    <div class="px-6 py-6 hover:bg-gray-50 transition duration-150">
                        <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600">
                                            ...
                                            <?php echo e($application->school->city); ?>

                                        </p>
                                        <div class="mt-2 flex flex-wrap gap-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($application->field_of_study); ?>

                                            </span>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                <?php echo e($application->diploma_level); ?>
                            ...
                            <div class="ml-6 flex flex-col items-end">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($application->status_badge); ?>">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('student.applications.show', $application)); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\EduConnect\resources\views/student/applications.blade.php ENDPATH**/ ?>