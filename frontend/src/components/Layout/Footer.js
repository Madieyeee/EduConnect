        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-secondary-300">
              La plateforme qui connecte les étudiants aux meilleures écoles et établissements d'enseignement supérieur. 
              Trouvez votre formation idéale et postulez en quelques clics.
            </p>
        ...
        <div className="mt-16 border-t border-secondary-700 pt-8 sm:mt-20 lg:mt-24">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-secondary-400 md:order-1 md:mt-0">
              &copy; {currentYear} EduConnect. Tous droits réservés.
            </p>
          </div>
        </div>
      </div>
